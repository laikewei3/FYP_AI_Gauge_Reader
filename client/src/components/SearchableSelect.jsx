...
const SearchableSelect = ({ disabled, multiple, error, helperTexts, options, label, placeholder, InputLabelProps, sx, margin, fullWidth, required, value, onInputChange, onChange }) => {
